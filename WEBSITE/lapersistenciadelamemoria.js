function generateGreco() {
    ...
    var n = Math.floor( Math.random() * 65);
    myImage.attr('src', "../website/images/lapersistenciadelamemoria/lapersistenciadelamemoria (" + n + ").jpg");
    // this statement uses the generated value to create a filename
    var path_to_img = "url(../website/images/lapersistenciadelamemoria/lapersistenciadelamemoria (" + n + ").jpg";
