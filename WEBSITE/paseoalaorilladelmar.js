function generateGreco() {
    ...
    var n = Math.floor( Math.random() * 107);
    myImage.attr('src', "../website/images/paseoalaorilladelmar/paseoalaorilladelmar (" + n + ").jpg");
    // this statement uses the generated value to create a filename
    var path_to_img = "url(../website/images/paseoalaorilladelmar/paseoalaorilladelmar (" + n + ").jpg";
